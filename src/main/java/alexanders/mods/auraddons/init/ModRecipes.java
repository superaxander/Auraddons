    ...
    public static void init() {
        if (ModConfig.blocks.enableAutoWrath)
            new TreeRitualRecipe(new ResourceLocation(MOD_ID, ModNames.RECIPE_AUTO_WRATH), Ingredient.fromStacks(new ItemStack(Blocks.ACACIA_SAPLING)),
                                 ...
                                 IngredientNBT.fromStacks(setType(new ItemStack(auraBottle), NaturesAuraAPI.TYPE_NETHER)), Ingredient.fromItems(infusedStone),
                                 Ingredient.fromItems(infusedIron), Ingredient.fromItems(shockwaveCreator), Ingredient.fromItems(infusedIron),
                                 IngredientNBT.fromStacks(setType(new ItemStack(auraBottle), NaturesAuraAPI.TYPE_NETHER)), Ingredient.fromItems(infusedStone)).register();
        if (ModConfig.items.enableSkyFeather) new OfferingRecipe(new ResourceLocation(MOD_ID, ModNames.RECIPE_SKY_FEATHER), new AmountIngredient(new ItemStack(Items.FEATHER, 1)),
                                                                 Ingredient.fromItems(callingSpirit), new ItemStack(ModItems.skyFeather)).register();
        ...
        if (ModConfig.blocks.enableAuraTransporter)
            new TreeRitualRecipe(new ResourceLocation(MOD_ID, ModNames.RECIPE_AURA_TRANSPORTER), Ingredient.fromStacks(new ItemStack(ancientSapling)),
                                 ...
                                 IngredientNBT.fromStacks(setType(new ItemStack(auraBottle), NaturesAuraAPI.TYPE_END)), Ingredient.fromItems(skyIngot),
        ...
        if (ModConfig.blocks.enableDisruptionCatalyst) {
            ...
            new AltarRecipe(new ResourceLocation(MOD_ID, ModNames.RECIPE_SANDSTONE_DISRUPTION), Ingredient.fromStacks(new ItemStack(Blocks.SANDSTONE)),
            ...
            new AltarRecipe(new ResourceLocation(MOD_ID, ModNames.RECIPE_SUGAR_CANE_DISRUPTION), Ingredient.fromStacks(new ItemStack(Items.SUGAR_CANE)),
                            new ItemStack(Items.SUGAR, 2), NaturesAuraAPI.TYPE_OVERWORLD, destructionCatalyst, 100, 50).register();
            ...
            new AltarRecipe(new ResourceLocation(MOD_ID, ModNames.RECIPE_BEACON_DISRUPTION), Ingredient.fromStacks(new ItemStack(Blocks.BEACON)),
                            new ItemStack(Items.NETHER_STAR, 1), NaturesAuraAPI.TYPE_OVERWORLD, destructionCatalyst, 200, 100).register();
        }
