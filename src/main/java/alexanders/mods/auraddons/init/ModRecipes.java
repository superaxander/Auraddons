...
public class ModRecipes {
    ...
    public static void init() {
        ...
        if (ModConfig.blocks.enableWitherProofer) {
            ...
            new TreeRitualRecipe(new ResourceLocation(MOD_ID, ModNames.RECIPE_WITHER_PROOFER), Ingredient.fromStacks(new ItemStack(Blocks.SAPLING, 1, BlockPlanks.EnumType.BIRCH.getMetadata())), new ItemStack(ModBlocks.witherProofer), ModConfig.general.witherProoferRitualTime, skullIngredient1, skullIngredient1, skullIngredient1, Ingredient.fromStacks(new ItemStack(Blocks.OBSIDIAN)), Ingredient.fromStacks(new ItemStack(Blocks.OBSIDIAN)), Ingredient.fromItem(skyIngot), Ingredient.fromItem(skyIngot), Ingredient.fromItem(Items.NETHER_STAR)).register();
